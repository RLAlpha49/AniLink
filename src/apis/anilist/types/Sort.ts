 ...
 * It can be one of the following: 'ID', 'ID_DESC', 'PINNED'.
 */
export const ActivitySortMappings = ["ID", "ID_DESC", "PINNED"];
 ...
 * It can be one of the following: 'ID', 'ID_DESC', 'RATING', 'RATING_DESC'.
 */
export const RecommendationSortMappings = ["ID", "ID_DESC", "RATING", "RATING_DESC"];
 ...
 * It can be one of the following: 'ID', 'ID_DESC'.
 */
export const ThreadCommentSortMappings = ["ID", "ID_DESC"];
