...
/**
 * {@link NotificationSchema} is the notification response selection: the shared fields of
 * every NotificationUnion variant, with the variant-specific payloads selected inline.
 * The notification queries send it.
