...
import {
    ActivityReplyQuery,
    type ActivityReplyVariables,
} from "./apis/anilist/query/ActivityReply";
import {
    ActivityRepliesQuery,
    type ActivityRepliesVariables,
} from "./apis/anilist/query/page/ActivityReplies";
import { ActivitiesQuery, type ActivitiesVariables } from "./apis/anilist/query/page/Activities";
import {
    AiringScheduleQuery,
    type AiringScheduleVariables,
} from "./apis/anilist/query/AiringSchedule";
...
} from "./apis/anilist/query/MediaListCollection";
...
} from "./apis/anilist/query/Recommendation";
...
} from "./apis/anilist/mutation/SaveMediaListEntry";
...
} from "./apis/anilist/query/ThreadComment";
...
} from "./apis/anilist/mutation/ToggleFollow";
import {
    ToggleFavouriteMutation,
    type ToggleFavouriteVariables,
} from "./apis/anilist/mutation/ToggleFavourite";
...
import { fuzzyDate, type FuzzyDateOptions } from "./apis/anilist/helpers/fuzzyDate";
import {
    flattenMediaListCollection,
    type FlattenedMediaListEntry,
} from "./apis/anilist/helpers/flattenMediaListCollection";
import {
    paginate,
    paginatePages,
    paginateChunks,
...
import type { FuzzyDateInput } from "./apis/anilist/types/FuzzyDate";
    ...
    constructor(authToken?: string, options?: AniLinkOptions) {
        ...
        this.anilist = {
            ...
            query: {
                ...
                notification:
                    notificationQueryInstance.notification.bind(notificationQueryInstance),
                ...
                aniChartUser:
                    aniChartUserQueryInstance.aniChartUser.bind(aniChartUserQueryInstance),
                ...
                page: {
                    ...
                    mediaTrends:
                        mediaTrendsQueryInstance.mediaTrends.bind(mediaTrendsQueryInstance),
            ...
            mutation: {
                ...
                deleteMediaListEntry:
                    deleteMediaListEntryMutationInstance.deleteMediaListEntry.bind(
                ...
                updateFavouriteOrder:
                    updateFavouriteOrderMutationInstance.updateFavouriteOrder.bind(
