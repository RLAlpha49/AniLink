...
- After data from a user's MyAnimeList account, or MAL anime and manga details? **MAL** — a focused REST surface: lookups, discovery reads, user-list reads, list-status updates, and `user.me`.
